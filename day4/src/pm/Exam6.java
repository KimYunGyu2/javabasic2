...
public class Exam6 {
	...
	public static void main(String[] args) {
		...
		// 배열의 특징
//		먼저 기본 자료형과 참조 자료형에서 변수를복사할때를 생각해보자.
//		대입 연산자(=)를 이요해서 변수가 복사되는 과정을 이해해보자
//		'변수의 복사'라는 말의 의미는 무엇일까.. 바로 변수에 포함된 메모리 값이다.
//		그런데 기본 자료형과 참조 자료형의 저장되는 메모리 값의의미가 다르다. 따라서
//		둘 사이에 차이가 발생된다.
//		
...
//		하나의 참조 변수를 이용해서 데이터를 수정하면
//		다른 참조변수가 가리키는 데이터도 변하게 된다.
		
		// 배열의 길이
//		.length '배열 참조 변수가 가리키는 곳에 배열 객체가 있고 그 배열의
//		갯수를 가져와라'
