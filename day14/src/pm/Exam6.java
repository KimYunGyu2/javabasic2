...
public class Exam6 {
	/*
	 Linked List 연결 리스트 
	 List<E>의 모든 공통 특징을 다 가지고 있다. (동질 자료, 동적 할당, 추가/변경/삭제 동일한 메서드 사용)
	...
	public static void main(String[] args) {
		...
		linkedlist1.add(5);
		  ...
		  //5. remove
		  linkedlist1.remove(1); // index 값을 삭제
		  System.out.println(linkedlist1.toString());
...
특정 인덱스 위치의 갓을 가져오기 위해서는 앞에서부터 차례로 번호를 세어가면서 인덱스의 위치를
찾아야 한다. 반면에 ArrayList는 데이터 자체에 인덱스 번호를 갖고 있으므로 특정 인덱스 위치의
데이터를 빠르게 찾을 수 있다.
