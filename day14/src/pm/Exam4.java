...
/*
 ...
 라이브러리라고 한다. 그런데 프레임 워크는 클래스 또는 인터페이스를 생성하는 과정에서 설계의 원칙
 또는 구조에 따라 클래스 또는 인터페이스를 설계하고 이렇게 설계된 클래스와 인터페이스를 묶어놓은 개념이다.
 ...
 그런데 2개가 필요없어졌다고 가정해보면 배열은 최초로 지정된 크기를 변경할 수 없으므로
 ...
 //리스트 생성
  ...
  List<E> 자체가 제네릭 인터페이스이므로 이를 구현한 클래스들도 제네릭 클래스이다. 즉
