...
//		System.out.println(str2);
		...
		// String 객체는 내용을 변경할수 없기 때문에 메모리에는 각각의
...
//		String str2 = "안녕하세요! 반갑습니다."; // 한글, 영어 모두 한문자당 1개로 count 한다.
//		
...
//		System.out.println(str1.substring(0,5)); // 0번째 부터 5미만 까지 슬라이싱
//		
//		// trim 여백 제거
//		System.out.println("     austin      ".trim());
		
		// 문자열의 내용비교 : 문자열을 비교할때는 == 절대 쓰지 말고 .equals() 를 사용하자.
		String str2 = new String("Java");
		String str3 = new String("Java");
		String str4 = new String("java");
		
		System.out.println(str2 == str3); // 글자 자체와는 상관 없이 같은 메모리 주소 인지 여부를 확인한다.
